...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ortho_3x10(
    ...
    */
    KC_NO, KC_NO, KC_NO, KC_ACL2, KC_NO, KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_NO,
    RESET, KC_NO, KC_NO, KC_ACL1, KC_NO, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_ACL0, KC_NO, KC_WH_L, KC_WH_R, KC_NO  , KC_NO  , KC_NO
  ),
